<div class="container">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6 offset-md-3 mt-3">
            <div class="container">
                <form action="<?=base_url()?>Access/submit_update_access_user" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <small class="bg-warning">Username tidak bisa diganti lagi</small>         
                </div>
                <div class="form-group">
